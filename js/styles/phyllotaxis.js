...
export const phyllotaxis = {
  ...
  defaults: {
    ...
    // 0 красило все точки в ramp(0) — самый тёмный цвет палитры, который
    // почти сливается с тёмным фоном (стиль выглядел пустым). 1 = один
    // полный проход по палитре вдоль спирали — видно и живо.
    paletteCycle: 1.0,
    dotMin: 0.6,
    dotMax: 2.4,
    spiralTwist: 0.0,
